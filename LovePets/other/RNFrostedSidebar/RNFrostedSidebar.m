...
- (void)layoutItems {
    ...
    [self.itemViews enumerateObjectsUsingBlock:^(RNCalloutItemView *view, NSUInteger idx, BOOL *stop) {
        CGRect frame;
            ...
            frame = CGRectMake(leftPadding, topPadding*idx + self.itemSize.height*idx + topPadding, self.itemSize.width, self.itemSize.height);
        
        
        
        NSInteger lineWeight = 45;
        ...
        else if(idx == 0)
        {
            ...
            frame = CGRectMake(leftPadding, topPadding*idx + self.itemSize.height*idx + 40, self.itemSize.width, self.itemSize.height);
        }
        else if (idx == 2)
        {
            frame = CGRectMake(0, 145, self.itemSize.width*2, lineWeight);
        }
        else if (idx == 3)
        {
            frame = CGRectMake(0, 145+lineWeight+1, self.itemSize.width*2, lineWeight);
        }
        else if (idx == 5 || idx == 6 || idx == 7)
        {
            frame = CGRectMake(0, 145+lineWeight*(idx-2)+(idx-5), self.itemSize.width*2, lineWeight);
        }
        else if (idx == 9)
        {
            frame = CGRectMake(0, 145+lineWeight*(idx-2), self.itemSize.width*2, lineWeight);
        }
        view.frame = frame;
